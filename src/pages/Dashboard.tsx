    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {kpiData.map((kpi) => (
          <Card
            key={kpi.title}
            className="relative overflow-hidden p-6 transition-all hover:shadow-lg hover:scale-[1.02]"
          >
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card className="p-6">
          <h3 className="mb-4 text-lg font-semibold">CV по дням</h3>
        ...
        <Card className="p-6">
          <h3 className="mb-4 text-lg font-semibold">Вакансии по сайтам</h3>
      ...
      {/* Recent Activity */}
      <Card className="p-6">
        <h3 className="mb-4 text-lg font-semibold">Последние действия</h3>
